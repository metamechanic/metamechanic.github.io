...
- see-also:: [[Metamechanic Portfolio]]
- see-also:: [[Metamechanic Mycelium]]
- People involved: myself, alone
- Audience: 1st degree friends, family, supporters, closest critical friends and collaborators
- Purpose:
  collapsed:: true
...
- MM Parallel Activity Streams:
  collapsed:: true
	- Write Project Briefs and pitch paragraphs 
	...
	- Blogs, articles, papers, books
	  logseq.order-list-type:: number
		- Identify/decide fundamental blogs and articles to write for each projects
		  logseq.order-list-type:: number
	...
	- logseq.order-list-type:: number
	- logseq.order-list-type:: number
- Content types to focus on for each project (copy-paste)
  collapsed:: true
	- Project briefs 1-page
	- Project briefs 5-page
	- Site maps
	- Defining, "fundamental" articles
	- inner-circle MVPs
	  collapsed:: true
		- website mock-ups
		- design ideas
...
- Focus projects for Phase 1
	...
	- D - deferred, delayed
		...
		-
- Metamechanic Mesh KM Phase 1 needs and not-needs
	- needs
